...
<br>
        ...
        <br>
        <h2>
            <center> Atualização de Cadastro</center>
        </h2>
        <br>

        <form action="..\Comandos\Alterar_Cli.php" method="POST">
            <div class="form-group col-md-12" text-alingn="center">
             ...
             <div class="form-group">
                 ...
                 <input type="text" name="txtnome" id="inputNome" class="form-control" value='<?php echo $dado_cli['nome'];?>'>
             </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-4">
                 <label for="inputCpf"> CPF </label>
                 <input type="text" class="form-control" name="txtcpf" id="inputCpf" value='<?php echo $dado_cli['cpf']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-4">
                 <label for="inputRG"> RG </label>
                 <input type="text" class="form-control" name="txtrg" id="inputRg" value='<?php echo $dado_cli['rg']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                 ...
                 <input type="email" class="form-control" name="txtemail" id="inputEmail" value='<?php echo $dado_cli['email']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-12">
                 <label for="inputEndereco"> Endereço </label>
                 <input type="text" class="form-control" name="txtendereco" id="inputEndereco" value='<?php echo $dado_cli['endereco']; ?>'>
             </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-6">
                 <label for="inputComplemento"> Complemento </label>
                 <input type="text" class="form-control" name="txtcomplemento" id="inputComplemento" value='<?php echo $dado_cli['complemento']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-6">
                 <label for="inputBairro"> Bairro </label>
                 <input type="text" class="form-control" name="txtbairro" id="inputBairro" value='<?php echo $dado_cli['bairro']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                <div class="form-group col-md-6">
                <label for="inputCidade"> Cidade </label>
                 <input type="text" class="form-control" name="txtcid" id="inputCidade" value='<?php echo $dado_cli['cidade']; ?>'>
                 </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-4">
                 <label for="inputEstado"> Estado </label>
                 <select id="inputEstado" name="txtestado" class="form-control" value='<?php echo $dado_cli['estado']; ?>'>
                 ...
                 <div class="form-row">
                     ...
                     <input type="text" class="form-control" name="txtcep" id="inputCep" value='<?php echo $dado_cli['cep']; ?>'>
                     </div>
                 </div>
                 <div class="form-group col-md-4">
