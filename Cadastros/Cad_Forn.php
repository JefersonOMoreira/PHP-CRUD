...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <br>
        <h2>
            <center> Cadastro de Fornecedores</center>
        </h2>
        <br>

        <form action="..\Comandos\Cadastro_Forn.php" method="POST">

            <div class="form-group">
                <div class="form-group col-md-12">
                <label for="inputName"> Razão Social </label>
                <input type="text" name="txtrazao" id="inputNome" class="form-control">
            </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                <label for="inputCpf"> CNPJ </label>
                <input type="text" class="form-control" name="txtcnpj" id="inputCpf">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                <label for="inputRG"> Incrição Estadual </label>
                <input type="text" class="form-control" name="txtinscriest" id="inputRg">
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <input type="text" class="form-control" name="txtendereco" id="inputEndereco">
            </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                <label for="inputComplemento"> Complemento </label>
                <input type="text" class="form-control" name="txtcomplemento" id="inputComplemento">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                <label for="inputBairro"> Bairro </label>
                <input type="text" class="form-control" name="txtbairro" id="inputBairro">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                <label for="inputCidade"> Cidade </label>
                <input type="text" class="form-control" name="txtcid" id="inputCidade">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                <label for="inputEstado"> Estado </label>
                <select id="inputEstado" name="txtestado" class="form-control">
                ...
                <div class="form-row">
                    ...
                    <input type="text" class="form-control" name="txtcep" id="inputCep">
                    </div>
                </div>
