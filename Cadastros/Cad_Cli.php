...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <form action="..\Comandos\Cadastro_Cli.php" method="POST">
            <div class="form-group col-md-12" text-alingn="center">

             <div class="form-group">
                 <div class="form-group col-md-12">
                 <label for="inputName"> Nome </label>
                 <input type="text" name="txtnome" id="inputNome" class="form-control">
             </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-4">
                 <label for="inputCpf"> CPF </label>
                 <input type="text" class="form-control" name="txtcpf" id="inputCpf">
                 </div>
             </div>
             <div class="form-row">
                 <div class="form-group col-md-4">
                 <label for="inputRG"> RG </label>
                 <input type="text" class="form-control" name="txtrg" id="inputRg">
                 </div>
             </div>
             <div class="form-row">
